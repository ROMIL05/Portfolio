  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        animate={{
          scale: hovered ? 0.8 : 1,
          x: hovered ? [0, -2.5, 2.5, -2.5, 2.5, 0] : 0,
...
export const CircleIcon = ({ className, delay }) => {
  return (
    <div
      className={`pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 group h-2 w-2 rounded-full bg-transparent dark:bg-transparent opacity-20 group-hover/cover:bg-transparent ${className}`}
    ></div>
  );
};
